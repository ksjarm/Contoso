...
public static class InitParents {
    ...
    internal static int cntParents = 10000;
    ...
    internal static List<ParentData> parents {
        get {
            var l = new List<ParentData> {
                parent("Sophia", "Alexander", "+372 58947384", IsoGender.Female),
                parent("Ethan", "Alonso", "+372 59384726", IsoGender.Male),
                parent("Ava", "Anand", "+372 55637894", IsoGender.Female),
                parent("Noah", "Barzdukas", "+372 52534566", IsoGender.Female),
                parent("Isabella", "Li", "+372 57558690", IsoGender.Female),
                parent("Liam", "Justice", "+372 5463748", IsoGender.Male),
                parent("Mia", "Norman", "+372 50068034", IsoGender.Female),
                parent("Lucas", "Olivetto", "+372 55886739", IsoGender.Male)
            };
    ...
    internal static ParentData parent(int idx, string phoneNr)
        => parent($"PFirstName{idx}", $"PLastName{idx}", $"{Texts.CountryCode} {phoneNr}", EnumHelper.GetRandomValue<IsoGender>());
    internal static ParentData parent(string firstName, string name, string phoneNr, IsoGender gender)
